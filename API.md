...
| <code><a href="#@alma-cdk/origin-verify.OriginVerify.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@alma-cdk/origin-verify.OriginVerify.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@alma-cdk/origin-verify.OriginVerify.with.parameter.mixins"></a>
